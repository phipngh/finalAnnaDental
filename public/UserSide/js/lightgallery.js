                        ...
                        (s.prototype.init = function() {
                            ...
                            (s.prototype.structure = function() {
                                ...
                                if (
                                    ...
                                    (this.outer = document.querySelector(
                                        ".lg-outer"
                                    )),
                                    this.outer.focus(),
                                    ...
                                    var a = this.outer.querySelector(
                                        ".lg-inner"
                                    );
                                    l.default.setVendor(
                                        a,
                                ...
                                if (i.s.dynamic) {
                                    ...
                                    if (
                                        (i.items[e].getAttribute(
                                            ...
                                            ((o = !0),
                                            (d = i.items[e].getAttribute(
                                                "data-poster"
                                            ))),
                                        (c = i.items[e].getAttribute(
                                            "data-html"
                                        )),
                                        (a =
                                    ...
                                    (n = i.items[e].getAttribute(
                                        "data-srcset"
                                    )),
                                        (u = i.items[e].getAttribute(
                                            "data-sizes"
                                        ));
                                }
                                var h = !1;
                            ...
                            (s.prototype.keyPress = function() {
                                var e = this;
                                this.items.length > 1 &&
                                    l.default.on(window, "keyup.lg", function(
                                        t
                                    ) {
                                        e.items.length > 1 &&
                                            (37 === t.keyCode &&
                                    ...
                                    l.default.on(window, "keydown.lg", function(
                                        t
                                    ) {
                                        !0 === e.s.escKey &&
                                            27 === t.keyCode &&
                            ...
                            (s.prototype.mousewheel = function() {
                                var e = this;
                                l.default.on(e.outer, "mousewheel.lg", function(
                                    t
                                ) {
                                    t.deltaY &&
                                        (t.deltaY > 0
