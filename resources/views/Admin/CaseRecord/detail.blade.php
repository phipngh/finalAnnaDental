...
<div class="row">
    ...
    <div class="col-6">
        <div class="card-box">
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a type="button" href="{{route('admin.presciption.detail',$crpr->id)}}" name="detail_crPresc" id="{{$crpr->id}}" class="detail_crPresc btn btn-info btn-sm rounded text-white">Detail</a>
                                    &nbsp;&nbsp;&nbsp;
                                    <button type="button" name="delete_crPresc" id="{{$crpr->id}}" class="delete_crPresc btn btn-danger btn-sm rounded">Delete</button>
                                </td>
                            </tr>
                            @php
                            $index++;
            ...
            @else
            <div class="col-12 text-center">
                <p>Theres no prescription recorded.</p>
                <a id="create_crPresc" name="create_crPresc" type="button" class="btn btn-primary mx-2 mb-2 text-light width-md"> <i class="fas fa-plus"></i><span> &nbsp;Add New Prescription</span></a>
