            ...
            <form id="sample_form" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="description" name="description" placeholder="Enter Service Description" rows="6"></textarea>

                    </div>

                    <div class="form-group">
                        <label>Note</label>
                        <textarea type="text" class="form-control" id="note" name="note" placeholder="Enter Service Note" rows="4"></textarea>
                    </div>
