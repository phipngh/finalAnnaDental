...
<div class="row">
    <div class="col-12">
        ...
        <div class="card-box table-responsive">
            <h4 class="header-title text-center"><b>Patient</b></h4>
            <table id="catelogy_patient" class="table  table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            <thead>
...
<script>
    $(document).ready(function() {
        $('#catelogy_patient').DataTable({
            "lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('admin.trash.patient') }}",
            },
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
        ...
        $(document).on('click', '.restore', function() {
            ...
            Swal.fire({
                ...
                if (t.value) {
                    $.ajax({
                        url: "/admin/patient/restore/" + id,
                        success: function(data) {
                            $('#catelogy_patient').DataTable().ajax.reload();
                        }
                    });
                    Swal.fire({
                        title: "Restored!",
