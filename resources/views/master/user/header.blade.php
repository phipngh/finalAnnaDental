            ...
            <div class="col-12 col-md-10 d-none d-xl-block">
                <nav class="site-navigation position-relative text-right" role="navigation">
                    ...
                    <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                        <li><a href="{{route('user.index')}}" class="nav-link {{request()->routeIs('user.index') ? 'active' : ''}}">Home</a></li>
                        ...
                        <li><a href="{{route('user.blog')}}" class="nav-link {{request()->routeIs('user.blog') ? 'active' : ''}}">Blog</a></li>
                        <li><a href="{{route('user.aboutus')}}" class="nav-link {{request()->routeIs('user.aboutus') ? 'active' : ''}}">About Us</a></li>
                        <li><a href="{{route('user.contactus')}}" class="nav-link {{request()->routeIs('user.contactus') ? 'active' : ''}}">Contact</a></li>
