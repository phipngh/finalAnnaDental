...
<div class="site-section">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 ml-auto my-auto">
...
<div class="site-section bg-1">
    <div class="container">
        <div class="row">
            <div class="col-lg-5 mr-auto my-auto">
                <span class="subheading">Our Mission</span>
                <h2 class="heading">We Provide <strong class="text-primary">High Solutions</strong> for Your Smile</h2>
            ...
            <div class="col-lg-6">
                <figure class="video-image">
                    ...
                    <img src="{{asset('UserSide/images/img_4.jpg')}}" alt="Image" class="img-fluid">
                </figure>
            </div>
        </div>
    </div>
...
<div class="site-section pt-0">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <p><img src="{{asset('UserSide/images/chair.jpg')}}" alt="Image" class="img-fluid"></p>
            </div>
